...
function wpcloaker_options() {
	...
	if(get_post_data('save')){
		...
		echo '<div class="updated"><p>Landing Page saved successfully.</p></div>';
	}
	...
	<form method="post" id="wpcloaker_options">
		...
		<table width="100%" class="editform">
			...
			<tr valign="top">
				...
				not contain the entire page url string -- just an identifying pattern. The format for each line is pattern->url|basehref. The basehref is optional. So for example, if you wanted
				...
				auto-insurance->http://www.geico.com</strong>. If you wanted to include a basehref then it would be <strong>auto insurance->http://geico.com|http://geico.com</strong></td>
			</tr>

			<tr valign="top">
				<th width="25%" scope="row">Do Not Cloak List:</th>
				<td>
			...
			<tr valign="top">
				<th width="25%" scope="row">Referrer List:</th>
				<td>
				...
				not contain the entire Referrer string -- just an identifying pattern. The format for each line is pattern->url|basehef. The base href is optional. So for example, if you wanted
				...
				widget->http://www.mywidgets.com</strong>. If you wanted to include a basehref then it would be <strong>widget->http://geico.com|http://geico.com</strong>, for example. 
			...
			<tr valign="top">
				...
				<br />Sets the list for Language cloaking. The format for each line is 'language code->url|basehref'. The base href is optional. So for example, if you wanted
				to cloak/redirect traffic coming from spain to http://es.mywidgets.com you would make a line:<strong>
				es->http://es.mywidgets.com</strong>. If you wanted to include a basehref then it would be <strong>es->http://geico.com|http://geico.com</strong> for example. 
...
add_action('template_redirect', 'wpcloaker_process');
